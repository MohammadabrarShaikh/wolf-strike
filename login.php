...
<div class="page-wrap">
    <div class="login-card">
        ...
        <div class="wolf-subtitle">IDENTIFY YOURSELF</div>

        <div class="wolf-divider">
            <div class="wolf-divider-line"></div>
            <div class="wolf-divider-text">LOGIN</div>
            <div class="wolf-divider-line"></div>
        </div>
        ...
        <form method="POST" action="login.php">
            ...
            <div class="field-wrap">
                ...
                <input type="text" name="username" class="wolf-input"
                       placeholder="Enter your callsign" required
        ...
        <div class="wolf-footer-text">
            No account yet?
            <a href="register.php" class="wolf-link">Register here →</a>
        </div>
